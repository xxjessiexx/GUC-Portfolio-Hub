  ...
  return (
    <AppCard className="overflow-hidden p-5">
      <div className="flex h-full min-h-[116px] items-center gap-4">
        ...
        <div className="h-16 w-36 min-w-0 shrink-0 opacity-90">
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid gap-5 xl:grid-cols-[1.35fr_0.9fr_0.95fr_0.85fr]">
        ...
        >
          <div className="h-[245px] min-w-0 rounded-[24px] border border-[rgba(53,88,114,0.12)] bg-white/55 p-4 dark:border-white/10 dark:bg-white/[0.035]">
            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={1}>
