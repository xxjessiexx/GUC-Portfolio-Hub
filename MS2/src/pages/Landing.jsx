  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[linear-gradient(135deg,#F7F8F0_0%,#EAF4FA_45%,#D8ECF8_100%)] text-[#102630]">
      <section className="relative min-h-screen px-6 py-6">
        <motion.div
          style={{ x: farX, y: farY }}
          className="pointer-events-none fixed -left-40 -top-40 h-[620px] w-[620px] rounded-full bg-[radial-gradient(circle,#9CD5FF_0%,rgba(122,170,206,0.25)_55%,transparent_72%)] blur-3xl dark:opacity-70"
        />
